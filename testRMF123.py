from testing.RMF import get_professor_rating
from testing.aiRating import rate_schedule  # Changed from analyze_schedule



result1 = get_professor_rating("Claire Wendland")
...
result2 = rate_schedule(schedule)  # Changed from analyze_schedule
print(result2)
